...
Partial Public Class ProyectoDataSet
    ...
    Partial Public Class UsuariosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddUsuariosRow(ByVal Nombre As String, ByVal Correo As String, ByVal Contrasena As String, ByVal id As Long) As UsuariosRow
            Dim rowUsuariosRow As UsuariosRow = CType(Me.NewRow,UsuariosRow)
            Dim columnValuesArray() As Object = New Object() {Nombre, Correo, Contrasena, id}
...
Namespace ProyectoDataSetTableAdapters
    ...
    Partial Public Class UsuariosTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Usuarios] ([Nombre], [Correo], [Contrasena], [id]) VALUES (@No"& _ 
                "mbre, @Correo, @Contrasena, @id)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Cahuita.My.MySettings.Default.ProyectoConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT Nombre, Correo, Contrasena, id FROM dbo.Usuarios"
        ...
        Public Overloads Overridable Function Insert(ByVal Nombre As String, ByVal Correo As String, ByVal Contrasena As String, ByVal id As Global.System.Nullable(Of Long)) As Integer
            ...
            If (id.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(3).Value = CType(id.Value,Long)
            Else
